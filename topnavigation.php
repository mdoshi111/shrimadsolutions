    ...
    <header class="main-header">
    	...
    	<div class="header-top">
        	<div class="auto-container clearfix">
            	...
            	<div class="top-left">
                	<ul class="clearfix">
                    	<li><a href="#">Welcome to Shrimad Solutions - Making businesses better</a></li>
                    </ul>
                </div>
                ...
                <div class="top-right">
                	<ul class="clearfix">
                    	<li><a href="#"><span class="icon flaticon-interface-7"></span> Email us at : info@shrimadsolutions.com</a></li>
                    </ul>
                </div>
        	...
        	<div class="auto-container">
            	<div class="clearfix">
                	...
                	<div class="pull-left logo-outer">
                    	<div class="logo"><a href="#"><img src="images/logo.jpg" alt="" title="Shrimad Solutions"></a></div>
                    </div>
                    ...
                    <div class="pull-right upper-right clearfix">
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
                                ...
                                <li><a href="#">(01) 302 287 5911</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
                                ...
                                <li>301 N Severgn Drive, Exton, PA 19341, USA.</li>
                            </ul>
                        </div>
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
                                ...
                                <li>Mon - Fri : 8:00 am to 6:00 pm</li>
                            </ul>
                        </div>
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown"><a href="training.php">Training</a>
                                    <ul>
                                        <li><a href="projects.html">UI Training</a></li>
                                        <li><a href="java-training.php">JAVA Training</a></li>
                                        <li><a href="projects-3.html">QA Training</a></li>
